class Careers::ApplicantsController < ApplicationController
  ...
  def new
    ...
    render operations: cable_car
      ...
      .text_content('#slideover-header', text: "#{@job.title} application"), content_type: 'text/vnd.cable-ready.json'
  end
  ...
  def create
    ...
    if @applicant.save
      ...
      render operations: cable_car
        .inner_html('#slideover-content', html: html)
        .set_attribute('#apply-button', name: 'disabled', value: ''), content_type: 'text/vnd.cable-ready.json'
    else
      html = render_to_string(partial: 'form', locals: { applicant: @applicant })
      render operations: cable_car
        .inner_html('#applicant-form', html: html), status: :unprocessable_entity, content_type: 'text/vnd.cable-ready.json'
    end
  end
