class CommentsController < ApplicationController
  ...
  def index
    ...
    render operations: cable_car
      ...
      .text_content('#slideover-header', text: "Comments on #{@commentable.name}"), content_type: 'text/vnd.cable-ready.json'
  end
  ...
  def create
    ...
    if @comment.save
      ...
      render operations: cable_car
        ...
        .replace('#comment-form', html: form_html), content_type: 'text/vnd.cable-ready.json'
    else
      html = render_to_string(partial: 'form', locals: { comment: @comment, commentable: @commentable })
      render operations: cable_car
        .inner_html('#comment-form', html: html), status: :unprocessable_entity, content_type: 'text/vnd.cable-ready.json'
    end
  end
