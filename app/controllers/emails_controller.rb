class EmailsController < ApplicationController
  ...
  def new
    ...
    render operations: cable_car
      .inner_html('#slideover-content', html: html)
      .text_content('#slideover-header', text: "Email #{@applicant.name}"), content_type: 'text/vnd.cable-ready.json'
  end
  ...
  def create
    ...
    if @email.save
      ...
      render operations: cable_car
        .inner_html('#email-form', html: html), status: :unprocessable_entity, content_type: 'text/vnd.cable-ready.json'
    end
  end
