class UsersController < ApplicationController
  ...
  def new
    ...
    render operations: cable_car
      ...
      .text_content('#slideover-header', text: 'Add a new user'), content_type: 'text/vnd.cable-ready.json'
  end
  ...
  def create
    ...
    if @user.save
      ...
      html = render_to_string(partial: 'form', locals: { user: @user })
      render operations: cable_car
        .inner_html('#user-form', html: html), status: :unprocessable_entity, content_type: 'text/vnd.cable-ready.json'
    end
  end
